...
export class ApplicationController {
    ...
    /**
    * Crea una nueva aplicación con subida de CV
    */
    @Post()
    @HttpCode(HttpStatus.CREATED)
    @UseInterceptors(FileInterceptor('cv'))
    @ApiConsumes('multipart/form-data')
    @ApiOperation({ summary: 'Crear una nueva aplicación para una vacante con CV' })
    @ApiResponse({
    ...
    async create(
        ...
        // Llamamos al servicio que se encargará de subir el archivo y crear la aplicación
        return this.applicationService.createWithCV(createDto, cvFile);
    }
